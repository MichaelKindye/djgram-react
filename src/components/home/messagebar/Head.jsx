    ...
    <Card className="w-full py-2 z-1 border-b-1 border-l-0 shadow-none transition-color transition-shadow rounded-none dark:bg-gray-900 bg-transparent flex">
        <div className="relative flex items-center gap-2 px-2">
            ...
            <div className="relative flex flex-col">
                <p className="font-bold text-gray-800">Anna</p>
                <div className="flex items-center gap-0.5 text-sm font-medium text-shadow-border text-purple-600 top-4.5 absolute">
                    ...
                    <span className="flex gap-0.5 absolute top-3 left-11">
                        <span className="animate-bounce delay-150 block w-1.5 h-1.5 bg-purple-600 rounded-full"></span>
                        <span className="animate-bounce delay-300 block w-1.5 h-1.5 bg-purple-600 rounded-full"></span>
                        <span className="animate-bounce delay-500 block w-1.5 h-1.5 bg-purple-600 rounded-full"></span>
                    </span>
                </div>
            </div>
        </div>
